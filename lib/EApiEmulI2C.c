...
I2CDevEmulator_t EmulateDIDEeprom     ;
I2CDevEmulator_t EmulateUDSEeprom     ;
I2CDevEmulator_t EmulateEPIEeprom     ;
I2CDevEmulator_t EmulateEeePExpEeprom ;
I2CDevEmulator_t EmulateCOM0MEeprom   ;
I2CDevEmulator_t EmulateCOM0CBEeprom  ;
...
typedef struct BusDevicesTbl_s{
  ...
  I2CDevEmulator_t *const Emulator  ; /* Emulator */
    ...
    )
{
  EApiStatusCode_t EApiStatusCode=EAPI_STATUS_SUCCESS;
        ...
        siFormattedMessage_M2(
              ...
              __LINE__              ,
              CfgData->cszFilename,
              "%3s CIDX=%04lX Arg1=%1lX DLEN=%04lX PLEN=%04lX"
    ...
    switch((CfgData->ExtendedCmd))  {      /* Emulate Standard IDX/CMD 
      ...
      default:
        ...
        siFormattedMessage_M2(
              ...
              __LINE__                              ,
              CfgData->cszFilename                  ,
              "CINDX=%04lX PLEN=%04lX EPLEN=%04lX\n",
              CfgData->CurIndx                      , 
  ...
  EApiStatusCode_t EApiStatusCode=EAPI_STATUS_SUCCESS;
    ...
    CmdDesc_t *pCurCmd;
        ...
        siFormattedMessage_M2(
              ...
              "%3s CCMD=%04lX Arg1=%1lX WLEN=%04lX RLEN=%04lX %02"PRIX8
...
typedef struct InterfaceIdsTbl_s{
  const EApiId_t         Id         ; /* I2C EAPI Bus Id */
